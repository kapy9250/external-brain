...
Also see our documentation for quickstart with the SDKs or CLI, and prototype agents repository.

## Use cases

You can see our cookbook for a number of interesting examples. Some of the common patterns I’ve noticed across these examples and my own work:
...
* **Long-horizon tasks**: Long-running tasks are an area where I think Managed Agents will be particularly useful. I’ve explored this by forking Auto-Research's auto-research repo and exploring a few different ideas. For example, I recently took an excellent research paper and had a Managed Agent explore ways to apply it to our engineering blog content.
...
I wrote an Anthropic engineering blog post with the team on the process of building Claude Managed Agents: a lesson we share in the post is that building agents to scale with Claude’s intelligence is an infrastructure challenge, not strictly a matter of harness design.
...
I'm excited about projects exploring different patterns of multi-agent orchestration or long-running tasks. One of the frustrations in building agents is keeping agent harnesses up with model capabilities. Claude Managed Agents handles the agent harness and infrastructure for you, allowing for explorations on top of the agent as a new core primitive in the Claude API.